...
def setup_mesh_and_model(config):
  ...
  dummy_input_ids = jnp.ones((128, 1), dtype=jnp.float32)  # Adjust dtype if necessary
  dummy_decoder_positions = jnp.ones((128, 1), dtype=jnp.float32)  # Adjust dtype if necessary
